...
export default function AboutPage() {
  ...
  const timelineEvents = [
    ...
    },
    {
      ...
      title: "เปิดสาขาแรก",
      description:
        "เปิดสาขาแรก สาขารังสิต เป็นสาขาแรกพร้อมให้บริการลูกค้าในกรุงเทพและปริมณฑล",
    },
    {
      year: "2015",
      title: "ขยายสู่กรุงเทพ",
      description: "เปิดสาขาสายไหม เพื่อรองรับการเติบโตของพื้นที่กรุงเทพ",
    },
    {
      year: "2020",
    ...
    {
      year: "2025",
      title: "เปิดบริการรับจัดสวน ปูหญ้า",
      description:
        "โดยทำราคาได้ถูกสุดในตลาด แต่คุณภาพดีเป็นที่พอใจลูกค้า เพราะว่าผลิตวัสดุ ทราย ดิน หิน เอง",
    },
    {
      year: "2025",
      title: "สาขาที่ 3",
      description: "เปิดสาขาสำโรง เพื่อบริการลูกค้าสมุทรปราการและใกล้เคียง",
    },
    {
      year: "ปัจจุบัน",
      title: "มากกว่า 30 ปี",
            ...
            <AnimatedSection direction="right" delay={200}>
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  ...
                  <p>
                    นอกจากนี้ PSV ยังมีบริการจัดสวน เป็นบริการใหม่ล่าสุด
                    ซึ่งได้รับผลตอบรับจากลูกค้าดีมากๆ และแรงขึ้นเรื่อยๆ
                    เนื่องจาก PSV จัดสวนได้ราคาถูกกว่าเจ้าอื่นถึง 60%
                    ในระดับผลงานและความสวยงามใกล้เคียงกัน
                  </p>
                </div>
            ...
            <div className="relative">
              ...
              <div className="space-y-12">
                {timelineEvents.map((event, index) => (
                  <AnimatedSection key={event.year} delay={index * 100}>
                    <div
        ...
        <div className="container mx-auto px-12">
          ...
          <div className="space-y-12">
            {branches.map((branch, index) => (
              <AnimatedSection key={branch.name} delay={index * 150}>
