        ...
        <div className="container mx-auto px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="bg-white p-6 rounded-lg border-2 border-(--psv-border)"
              >
        ...
        <div className="container mx-auto px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="p-6 flex flex-col grow">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold text-gray-900">1.5 คิว</span>
                  </div>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed grow">
                  เหมาะสำหรับการส่งวัสดุน้อยๆ
                  เช่นพวกกระสอบและหน้างานมีข้อจำกัดพื้นที่ในการขนส่ง
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden border-2 border-(--psv-border) flex flex-col">
              ...
              <div className="p-6 flex flex-col grow">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">ความจุ:</span>
                    <span className="font-semibold text-gray-900">5 คิว</span>
                  </div>
                  <div className="flex justify-between text-sm">
                ...
                <p className="text-gray-600 text-sm leading-relaxed grow">
                  เหมาะกับการขนทรายปริมาณน้อย และหน้างานมีพื้นที่จำกัด
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden border-2 border-(--psv-border) flex flex-col">
              ...
              <div className="p-6 flex flex-col grow">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">ความจุ:</span>
                    <span className="font-semibold text-gray-900">10 คิว</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">น้ำหนัก:</span>
                    <span className="font-semibold text-gray-900">15 ตัน</span>
                  </div>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed grow">
                  เหมาะกับหน้างานที่มีพื้นที่จำกัด รถพ่วงไม่สามารถกลับรถได้
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden border-2 border-(--psv-border) flex flex-col">
              ...
              <div className="p-6 flex flex-col grow">
                <h3 className="text-xl font-bold text-gray-900 mb-3">รถพ่วง</h3>
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">ความจุ:</span>
                    <span className="font-semibold text-gray-900">20 คิว</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">น้ำหนัก:</span>
                    <span className="font-semibold text-gray-900">
                ...
                <p className="text-gray-600 text-sm leading-relaxed grow">
                  สำหรับหน้างานขนาดใหญ่ สามารถแยกสินค้าได้ 2 ชนิดในการขนส่ง
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[1, 2, 3, 4].map((index) => (
              <div
                key={`site-${index}`}
                className="aspect-square bg-gray-200 rounded-lg overflow-hidden border-2 border-(--psv-border)"
              >
                <img
                  src={`/site${index}.jpg`}
                  alt={`โครงการที่ ${index}`}
                  className="w-full h-full object-cover"
                />
              </div>
            ))}
