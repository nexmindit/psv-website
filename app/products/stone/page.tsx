        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            {constructionStoneTypes.map((stone, index) => (
              <div
                key={index}
                className={`relative bg-gradient-to-br ${stone.bgGradient} p-8 sm:p-10 rounded-2xl text-white shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 overflow-hidden group`}
              >
